...
# Main aid creating this: https://pytorch.org/tutorials/beginner/hyperparameter_tuning_tutorial.html
...
def main(num_samples=10, max_num_epochs=10, gpus_per_trial=1):
    ...
    config = {
        ...
        "wandb": {"project": "hanatTune-trackmania-new-acc", "name": "trackmania"},
    }
