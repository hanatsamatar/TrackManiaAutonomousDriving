...
# XboxController wrapper modified from: https://stackoverflow.com/questions/46506850/how-can-i-get-input-from-an-xbox-one-controller-in-python
class XboxController(object):
    ...
    def read(self):  # input buttons/triggers that you want here
        steer = (
            self.LeftJoystickX
...
if __name__ == "__main__":
    try:
        ...
        save_buffer = SaveBuffer(
            ...
            r"G:/Documents/TrackmaniaSelfDrivingData/",
            "png",
        )
